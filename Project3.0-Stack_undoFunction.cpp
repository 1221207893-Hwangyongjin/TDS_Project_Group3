...
public:
	...
	void checkout(PaymentMethod* payment) {
		...
		int orderIdForSave = 1 + getMaxIdFromFile("orders.txt");
...
void basicOperations(ADTstack &mainStack) {
...
void adminMenu() {
    ...
    do {
        cout << "Menu:" << endl
             ...
             << "3. Remove a Product (Latest)" << endl
             << "4. Save to File" << endl
        ...
        case 2: {
			...
			p.id = 1 + getMaxIdFromFile(filename);
